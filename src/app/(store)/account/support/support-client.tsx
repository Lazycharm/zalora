    ...
    <div className="flex flex-col min-h-screen bg-background pb-20 lg:pb-0">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="container mx-auto px-4 py-6">
          {/* Queue status bar - reference */}
          <div className="mb-4 rounded-lg bg-primary/10 border border-primary/20 px-4 py-3 flex items-center gap-2 text-sm text-foreground">
            <Icon icon="solar:bell-bold" className="size-5 text-primary shrink-0" />
            <span>You have successfully entered the queue. An agent will be with you shortly.</span>
          </div>

          <div className="hidden lg:block mb-6">
            <h1 className="text-3xl font-bold font-heading">Online Customer Service</h1>
            <p className="text-muted-foreground mt-2">Your tickets and conversations with support</p>
          </div>
